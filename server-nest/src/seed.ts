...
async function main() {
  ...
  const users = [
  { username: 'admin1', email: 'rivo.andrian@dgf.mg', fullName: 'Rivo Andrian', role: Role.ADMIN_FISCAL, phone: '+261320000003', avatar: '/sefo.jpg' },
  { username: 'agent1', email: 'mamy.haja@impots.mg', fullName: 'Mamy Haja', role: Role.AGENT_FISCAL, phone: '+261320000001', avatar: '/Jyeuhair.jpg' },
  { username: 'patterson', email: 'patterson.johnson@merakiteam.mg', fullName: 'Patterson Johnson', role: Role.ENTREPRISE, phone: '+261341112223', entrepriseSiret: 'MT-0001', avatar: '/fitiavana.jpg' },
  { username: 'claire', email: 'claire.beta@beta-sas.mg', fullName: 'Claire Beta', role: Role.ENTREPRISE, phone: '+261330000002', entrepriseSiret: 'BETA-0002', avatar: '/rijade.png' },
  { username: 'aina.admin', email: 'aina.randria@dgf.mg', fullName: 'Aina Randria', role: Role.ADMIN_FISCAL, phone: '+261341234567', avatar: '/tsiaro.png' },
  ] as Array<any>
